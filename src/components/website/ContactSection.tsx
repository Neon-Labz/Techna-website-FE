...
export default function ContactSection() {
  ...
  const contactInfo = [
    { icon: Phone, label: 'Phone', value: '0771703549', sub: 'Mon-Sun, 8AM-6PM', href: 'tel:0771703549' },
    { icon: Mail, label: 'Email', value: 'technatechnicalinstitute@gmail.com', sub: 'We reply within 24 hours', href: 'mailto:technatechnicalinstitute@gmail.com' },
    { icon: MapPin, label: 'Address', value: 'Veerasingam Hall, 3rd Floor, Jaffna', sub: 'Sri Lanka', href: '#' },
    { icon: Clock, label: 'Office Hours', value: 'Mon-Sun: 8AM-6PM', sub: 'Open all week', href: '#' },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-blue-950 to-blue-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-300 mt-3 max-w-xl mx-auto">Have questions about admissions, courses, or anything else? We are here to help!</p>
        </div>
      </div>
          ...
          <div className="lg:col-span-1 space-y-5">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 h-48 flex items-center justify-center">
              <div className="text-center text-gray-400">
                ...
                <p className="text-sm font-medium">Veerasingam Hall, 3rd Floor</p>
              ...
              {sent ? (
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="mt-6 px-6 py-2.5 bg-blue-900 text-white rounded-xl text-sm font-medium hover:bg-blue-800 transition-all"
                  >
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mb-6">Fill in the form below and we will get back to you as soon as possible.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 text-gray-700"
                        >
